...
export function Modal({ open, onClose, title, children, actions, size = 'md' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${sizes[size]} bg-[#111113] border border-[rgba(255,255,255,0.07)] rounded-card shadow-2xl max-h-[90vh] flex flex-col`}>
        <div className="flex items-center justify-between p-5 border-b border-[rgba(255,255,255,0.07)] shrink-0">
          <h2 className="font-display text-base font-semibold text-[#fafafa] tracking-tight">{title}</h2>
